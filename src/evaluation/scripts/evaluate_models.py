...
Contributors:
- Alex: Implemented model loading and ensemble evaluation (50%)
- Monty: Created visualisation functions and metrics calculation (40%)
- Jakub: Contributed to data loading and error handling (10%)
"""
...
def create_comparison_visualizations(results_df):
    ...
    print(f"Performance comparison visualisation saved to {output_dir / 'model_comparison_metrics.png'}")
